<template>
    <div :class="active || searchInput.length > 0 ? 'active' : ''" class="as-container search-entire-arr-sys main-div as-margin-top-space-3 as-display-flex">
...
<style scoped>
.search-entire-arr-sys.main-div, .search-div, .search-input-arr-sys {
    width: 220px !important;
    transition: .15s width !important;
}
.search-entire-arr-sys.main-div.active,
.search-entire-arr-sys.main-div.active .search-div, 
.search-entire-arr-sys.main-div.active .search-div .search-input-arr-sys {
...
.search-entire-arr-sys.main-div.active .search-div .button-icon {
...
.search-entire-arr-sys.main-div.active .search-div .button-icon button {
    background: transparent !important;
    border: none;
    padding: 0;
    margin: auto !important;
...
.search-entire-arr-sys .results-div {
    position: absolute !important;
...
.search-entire-arr-sys .results-div .result-item {
...
.search-entire-arr-sys .results-div .result-item:hover {
    background: var(--color-primary-grey-light) !important;
    border-color: var(--color-primary-grey-light) !important;
}
.search-entire-arr-sys.main-div.active .search-div .button-icon button.reset-all {
